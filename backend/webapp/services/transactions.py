...
def upsert_customer(device: Device, customer_data: CustomerInput, session: SessionDep):
    ...
    if not customer:        
        ...
        if customer and customer_data.time <= customer.last_txn_time:
            return None, None
        # increment counts
        ...
        old_avg_amount, old_amount_M2 = customer.avg_amount, customer.amount_M2
        ...
        old_avg_time_between_txn, old_time_M2  = customer.avg_time_between_txn, customer.time_M2        
        ...
        old_avg_device_freq, old_device_M2 = customer.avg_device_freq, customer.device_M2
        ...
        z_scores = {"amount": get_z_score(customer_data.amount, customer.txn_count, old_avg_amount, old_amount_M2),
                    "time": get_z_score(txn_time_delta, customer.txn_count, old_avg_time_between_txn, old_time_M2),
                    "device": get_z_score(device.frequency, customer.device_count, old_avg_device_freq, old_device_M2)
                    }
